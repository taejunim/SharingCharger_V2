...
public class PointChargeActivity extends BaseActivity {
    ...
    private void pointCharge() {
        ...
        } else if (binding.pointCardEd1.getText().toString().trim().length() != 2) {
            Toast.makeText(this, "카드번호를 입력해 주세요.", Toast.LENGTH_SHORT).show();
            binding.pointCardEd1.requestFocus();
            isPointBtnClick = false;
        } else if (binding.pointCardEd2.getText().toString().trim().length() != 2) {
            Toast.makeText(this, "카드번호를 입력해 주세요.", Toast.LENGTH_SHORT).show();
            binding.pointCardEd2.requestFocus();
            isPointBtnClick = false;
        } else if (binding.pointCardEd3.getText().toString().trim().length() != 2) {
            Toast.makeText(this, "카드번호를 입력해 주세요.", Toast.LENGTH_SHORT).show();
            binding.pointCardEd3.requestFocus();
            isPointBtnClick = false;
        } else if (binding.pointCardEd4.getText().toString().trim().length() != 2) {
            Toast.makeText(this, "카드번호를 입력해 주세요.", Toast.LENGTH_SHORT).show();
        ...
        Log.e("metis", "금액 : " + binding.chargingPointEdit.getText().toString());
    ...
    private void getCurrentPoint() {
        ...
        try {
            ...
            Log.e("metis", "pointDialog Exception : " + e);
        }
